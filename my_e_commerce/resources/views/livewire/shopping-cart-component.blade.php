        ...
        <ul class="space-y-4">
          @foreach($cartItems as $item)
            <li class="flex items-center gap-4">
              <img src="{{ ($item->product->image) }}" alt="" class="size-16  rounded object-contain" />
              ...
              <div class="flex flex-1 items-center justify-end gap-2">
                <form>
                  <label for="Line{{ $item->id }}Qty" class="sr-only"> Số lượng </label>
                ...
                <button wire:click="removeItem({{ $item->id }})" class="text-gray-600 transition hover:text-red-600">
                  <span class="sr-only">Xoá sản phẩm</span>
          ...
          <div class="w-screen max-w-lg space-y-4">
            ...
            <div class="flex justify-end">
              <span class="inline-flex items-center justify-center rounded-full bg-indigo-100 px-2.5 py-0.5 text-indigo-700">
                ...
                <p class="whitespace-nowrap text-xs">1 Mã giảm giá đã được áp dụng</p>
              </span>
            </div>
            ...
            <div class="flex justify-end gap-2">
              ...
              <a href="#" class="flex gap-3 items-center rounded bg-red-700 px-5 py-3 text-sm text-gray-100 transition hover:bg-gray-600">
